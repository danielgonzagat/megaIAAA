...
def get_optim_scheduler(parameters, lr, momentum, decay, nesterov, epochs, warmup_epoch, eta_min):
  optim = torch.optim.SGD(parameters, lr, momentum=momentum, weight_decay=decay, nesterov=nesterov)
  T_max = epochs
  scheduler = CosineAnnealingLR(optim, warmup_epoch, epochs, T_max, eta_min)
