...
from eval_architecture.ofa.utils import (
    get_same_padding,
    min_divisible_value,
    SEModule,
    ShuffleLayer,
)
from eval_architecture.ofa.utils import MyNetwork, MyModule
from eval_architecture.ofa.utils import build_activation, make_divisible
