...
from eval_architecture.ofa.utils.layers import ResNetBottleneckBlock, ResidualBlock
from eval_architecture.ofa.utils import make_divisible, MyNetwork, MyGlobalAvgPool2d
